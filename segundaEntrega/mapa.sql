...
-- INSERT USUARIOS
insert into usuario values (null, 'Abigail', 'Gómez', '1998-6-5'), (null, 'Samuel', 'Martinez', '1998-8-5'),
                           (null, 'Mayra', 'Ayala', '1998-8-5'), (null, 'William', 'Lozano', '1998-8-5'),
                           (null, 'Anna', 'Milanesa', '1998-8-5'), (null, 'Leyla', 'Ramirez', '1998-8-5'),
                           (null, 'Samira', 'Ortiz', '1998-8-5');
...
begin
      ...
      set nacimiento = (select fecha_nac from usuario where nombre like nombre_user);
	   set edad = year(curdate()) - year(nacimiento);
	   if (month(curdate()) < month(nacimiento))
      or (month(curdate()) = month(nacimiento) and day(curdate()) < day(nacimiento))
